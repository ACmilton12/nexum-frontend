    ...
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="max-w-[450px]">
      <div className="flex flex-col items-center text-center mx-auto">
        ...
        <p className="text-[14px] text-[#5b6472] dark:text-gray-400 leading-relaxed mb-8">
          ...
          <span className="font-bold text-[#1a1a2e] dark:text-white">"{projectName}"</span>? Esta
          acción no se puede deshacer y eliminará permanentemente todos los datos asociados al
          mismo.
        </p>
