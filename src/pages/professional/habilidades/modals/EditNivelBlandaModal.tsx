...
export default function EditNivelBlandaModal({
  ...
  const niveles: {
    ...
    {
      key: 'En formación',
      desc: 'Estoy desarrollando esta habilidad activamente.',
      dot: 'bg-pink-400',
    ...
    {
      key: 'Desarrollada',
      desc: 'La aplico con seguridad en contextos reales.',
      dot: 'bg-indigo-400',
    ...
    {
      key: 'Fortalecida',
      desc: 'Es una de mis fortalezas consolidadas.',
      dot: 'bg-purple-500',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mx-6 mt-4 px-3 py-2.5 rounded-lg bg-navbar/5 border border-navbar/10 flex items-start gap-2">
          <svg
            className="w-3.5 h-3.5 text-navbar/60 mt-0.5 flex-shrink-0"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
          ...
          <p className="text-xs text-navbar">
            Las habilidades blandas se valoran por su presencia y madurez. Elige el nivel que mejor
            refleje tu situación actual.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className={`text-sm font-semibold ${isActive ? n.text : 'text-gray-700'}`}>
                      {n.key}
                    </p>
        ...
        <div className="flex gap-3 justify-end px-6 py-4 border-t border-gray-100">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white bg-navbar rounded-lg hover:bg-navbar/90 active:scale-95 transition-all disabled:opacity-60"
          >
