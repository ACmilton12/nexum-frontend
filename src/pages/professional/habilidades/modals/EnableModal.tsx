    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-md mx-4 p-5 sm:p-6 max-h-[90vh] overflow-y-auto border border-transparent dark:border-slate-800">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-base font-semibold text-textMain dark:text-white">Re-habilitar habilidad</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Volverá a ser visible en tu portafolio</p>
          </div>
        </div>

        <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ¿Deseas volver a mostrar{" "}
          <span className="font-semibold text-gray-900 dark:text-white">"{skill.nombre}"</span> en tu perfil?
        </p>
