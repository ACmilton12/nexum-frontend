        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t(
                'skills.suggest_modal.name_placeholder',
                'Ej. Kotlin, Design Thinking...'
              )}
              disabled={loading}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t(
                'skills.suggest_modal.justification_placeholder',
                '¿Por qué debería estar en el catálogo? ¿Para qué la usas?'
              )}
              rows={3}
              disabled={loading}
          ...
          <div className="flex items-start gap-2 p-3 rounded-lg bg-action/5 dark:bg-red-900/10 border border-action/20 dark:border-red-900/30">
            <svg
              className="w-3.5 h-3.5 text-action dark:text-red-400 mt-0.5 flex-shrink-0"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
            ...
            <p className="text-xs text-action dark:text-red-400">
              {t(
                'skills.suggest_modal.disclaimer',
                'La sugerencia requiere aprobación del administrador antes de poder agregarse a perfiles.'
              )}
            </p>
          </div>
        </div>
